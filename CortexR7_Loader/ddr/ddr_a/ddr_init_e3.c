 ...
 * rev.0.10    2018/10/09    Add Workaround for DRAM limitation (PDR)
 *                           ddr_init_e3.h : RCAR_E3_DDR_VERSION "rev.0.09" -> "rev.0.10"
