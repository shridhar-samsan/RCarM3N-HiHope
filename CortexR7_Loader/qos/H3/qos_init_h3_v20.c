...
#define QOSWT_WTSET0_PERIOD0_H3_20	((QOSWT_TIME_BANK0 /	\
					  QOSWT_WTSET0_CYCLE_H3_20) - 1U)
#define QOSWT_WTSET0_SSLOT0		(QOSWT_WTSET0_REQ_SSLOT0 - 1U)
#define QOSWT_WTSET0_SLOTSLOT0		(WT_BASE_SUB_SLOT_NUM0 - 1U)

#define QOSWT_WTSET1_PERIOD1_H3_20	((QOSWT_TIME_BANK0 /	\
					  QOSWT_WTSET0_CYCLE_H3_20) - 1U)
...
void qos_init_h3_v20(void)
{
...
#if RCAR_REWT_TRAINING != RCAR_REWT_TRAINING_DISABLE
	io_write_32(QOSCTRL_REF_ARS, QOSCTRL_REF_ARS_ARBSTOPCYCLE_H3_20 << 16);
#else
	...
	io_write_32(QOSWT_WTSET0, ((QOSWT_WTSET0_PERIOD0_H3_20 << 16) |
		    (QOSWT_WTSET0_SSLOT0 << 8) | QOSWT_WTSET0_SLOTSLOT0));
	io_write_32(QOSWT_WTSET1, ((QOSWT_WTSET1_PERIOD1_H3_20 << 16) |
