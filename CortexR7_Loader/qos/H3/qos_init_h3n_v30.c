...
#define QOSWT_WTSET0_PERIOD0_H3N		((QOSWT_TIME_BANK0 /	\
						  QOSWT_WTSET0_CYCLE_H3N) - 1U)
...
void qos_init_h3n_v30(void)
{
  ...
  #error "Don't set DRAM Split 4ch(H3N)"
	...
	io_write_32(QOSCTRL_REF_ARS, QOSCTRL_REF_ARS_ARBSTOPCYCLE_H3N << 16);
	...
	io_write_32(QOSWT_WTSET0, ((QOSWT_WTSET0_PERIOD0_H3N << 16) |
		    (QOSWT_WTSET0_SSLOT0 << 8) | QOSWT_WTSET0_SLOTSLOT0));
	io_write_32(QOSWT_WTSET1, ((QOSWT_WTSET1_PERIOD1_H3N << 16) |
