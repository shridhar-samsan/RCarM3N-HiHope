...
#define QOSWT_WTSET0_PERIOD0_M3_30	((QOSWT_TIME_BANK0 /	\
					 QOSWT_WTSET0_CYCLE_M3_30) - 1U)
#define QOSWT_WTSET0_SSLOT0		(QOSWT_WTSET0_REQ_SSLOT0 - 1U)
#define QOSWT_WTSET0_SLOTSLOT0		(WT_BASE_SUB_SLOT_NUM0 - 1U)

#define QOSWT_WTSET1_PERIOD1_M3_30	((QOSWT_TIME_BANK0 /	\
					 QOSWT_WTSET0_CYCLE_M3_30) - 1U)
...
void qos_init_m3_v30(void)
{
  ...
  #error "Don't set DRAM Split 4ch(M3)"
	...
	io_write_32(QOSWT_WTSET0, ((QOSWT_WTSET0_PERIOD0_M3_30 << 16) |
		    (QOSWT_WTSET0_SSLOT0 << 8) | QOSWT_WTSET0_SLOTSLOT0));
	io_write_32(QOSWT_WTSET1, ((QOSWT_WTSET1_PERIOD1_M3_30 << 16) |
