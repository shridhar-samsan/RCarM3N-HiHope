/*
 Image file name is Blinker_right.tga
 ...
 RLE image data start at byte 18 and end at byte 11835.
*/
...
static uint8_t *locTurnRightDataPtr = (uint8_t*)0;

const Img_t TurnRight = {
    "cluster_turn_right.bin",
    64,
    62,
    IMG_ARGB8888,
    0,
