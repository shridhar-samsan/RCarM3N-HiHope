/*
 Image file name is CoolingLiquidOn.tga
 ...
 RLE image data start at byte 18 and end at byte 11701.
*/
...
static uint8_t *locCoolingLiquidOnDataPtr = (uint8_t*)0;

const Img_t CoolingLiquidOn = {
    "cluster_CoolingLiquidOn.bin",
    58,
    60,
    IMG_ARGB8888,
    0,
