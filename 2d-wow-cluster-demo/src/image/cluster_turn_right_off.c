...
static uint8_t *locTurnRightOffDataPtr = (uint8_t*)0;

const Img_t TurnRightOff = {
    "cluster_turn_right_off.bin",
    64,
    62,
    IMG_ARGB8888,
    0,
