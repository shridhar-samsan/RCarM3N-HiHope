/*
 Image file name is gear_p_off.tga
 ...
 RLE image data start at byte 18 and end at byte 17720.
*/
...
static uint8_t *locGearPOffDataPtr = (uint8_t*)0;

const Img_t GearPOff = {
    "cluster_gear_p_off.bin",
    62,
    101,
    IMG_ARGB8888,
    0,
