/*
 Image file name is Blinker_left.tga
 ...
 RLE image data start at byte 18 and end at byte 11833.
*/
...
static uint8_t *locTurnLeftDataPtr = (uint8_t*)0;

const Img_t TurnLeft = {
    "cluster_turn_left.bin",
    64,
    62,
    IMG_ARGB8888,
    0,
