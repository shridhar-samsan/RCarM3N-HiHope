/*
 Image file name is HighLightOn.tga
 ...
 RLE image data start at byte 18 and end at byte 12427.
*/
...
static uint8_t *locHighLightOnDataPtr = (uint8_t*)0;

const Img_t HighLightOn = {
    "cluster_HighLightOn.bin",
    72,
    50,
    IMG_ARGB8888,
    0,
