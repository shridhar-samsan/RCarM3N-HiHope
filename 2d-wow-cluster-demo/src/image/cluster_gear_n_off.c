/*
 Image file name is gear_n_off.tga
 ...
 RLE image data start at byte 18 and end at byte 17752.
*/
...
static uint8_t *locGearNOffDataPtr = (uint8_t*)0;

const Img_t GearNOff = {
    "cluster_gear_n_off.bin",
    62,
    101,
    IMG_ARGB8888,
    0,
