/*
 Image file name is AirbagOn.tga
 ...
 RLE image data start at byte 18 and end at byte 13045.
*/
...
static uint8_t *locAirbagOnDataPtr = (uint8_t*)0;

const Img_t AirbagOn = {
    "cluster_AirbagOn.bin",
    56,
    62,
    IMG_ARGB8888,
    0,
