/*
 Image file name is FuelEmptyOff.tga
 ...
 RLE image data start at byte 18 and end at byte 10387.
*/
...
static uint8_t *locFuelEmptyOffDataPtr = (uint8_t*)0;

const Img_t FuelEmptyOff = {
    "cluster_FuelEmptyOff.bin",
    51,
    55,
    IMG_ARGB8888,
    0,
