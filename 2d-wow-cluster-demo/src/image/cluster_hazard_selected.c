/*
 Image file name is Hazard_Icon_Selected.tga
 ...
 RLE image data start at byte 18 and end at byte 7282.
*/
...
static uint8_t *locHazardSelectedDataPtr = (uint8_t*)0;

const Img_t HazardSelected = {
    "cluster_hazard_selected.bin",
    56,
    45,
    IMG_ARGB8888,
    0,
