/*
 Image file name is WipingOn.tga
 ...
 RLE image data start at byte 18 and end at byte 12949.
*/
...
static uint8_t *locWipingOnDataPtr = (uint8_t*)0;

const Img_t WipingOn = {
    "cluster_WipingOn.bin",
    65,
    58,
    IMG_ARGB8888,
    0,
