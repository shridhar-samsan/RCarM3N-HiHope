/*
 Image file name is Blinker_left_off.tga
 ...
 RLE image data start at byte 18 and end at byte 10638.
*/
...
static uint8_t *locTurnLeftOffDataPtr = (uint8_t*)0;

const Img_t TurnLeftOff = {
    "cluster_turn_left_off.bin",
    64,
    62,
    IMG_ARGB8888,
    0,
