...
int board_fit_config_name_match(const char *name)
{
	...
	/*
	 * Primary initialization of gd->dram_bank_size and
	 * gd->dram_bank_size from FDT passed from BL2.
	 */
	if (dram_init_banksize())
		return -1;

	bank_num = gd->dram_bank_num;
	bank_size = gd->dram_bank_size;
