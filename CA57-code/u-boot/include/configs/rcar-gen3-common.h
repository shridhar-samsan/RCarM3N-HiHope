...
#define CONFIG_SYS_SDRAM_SIZE		(0x10000000u - DRAM_RSV_SIZE)  /* 2GB - 128MB = 1.875GB (32-bit safe) */
#define CONFIG_SYS_LOAD_ADDR		0x58000000
#define CONFIG_LOADADDR			CONFIG_SYS_LOAD_ADDR
#define CONFIG_VERY_BIG_RAM
#define CONFIG_MAX_MEM_MAPPED		(0x10000000u - DRAM_RSV_SIZE)  /* 2GB - 128MB = 1.875GB (32-bit safe) */

#define CONFIG_SYS_MONITOR_BASE		0x00000000
#define CONFIG_SYS_MONITOR_LEN		(1 * 1024 * 1024)
#define CONFIG_SYS_MALLOC_LEN		((192+384) * 1024 * 1024)
