...
static const uint64_t BL31_RO_BASE		= (unsigned long)(&__RO_START__);
static const uint64_t BL31_RO_LIMIT		= (unsigned long)(&__RO_END__);

#if USE_COHERENT_MEM
static const uint64_t BL31_COHERENT_RAM_BASE	= (unsigned long)(&__COHERENT_RAM_START__);
static const uint64_t BL31_COHERENT_RAM_LIMIT	= (unsigned long)(&__COHERENT_RAM_END__);
#endif
