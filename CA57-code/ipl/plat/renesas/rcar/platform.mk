...
# Process SOFTRESET_FOR_RAMOOPS flag
ifndef SOFTRESET_FOR_RAMOOPS
SOFTRESET_FOR_RAMOOPS := 1
endif
$(eval $(call add_define,SOFTRESET_FOR_RAMOOPS))
...
# HiHope boards cannot support system suspend (no PMIC)
...
PLAT_INCLUDES	:=	-Idrivers/renesas/rcar/ddr		\
			...
			-Itools/renesas/rcar_layout_create
...
BL2_SOURCES	+=	${RCAR_GIC_SOURCES}				\
			...
			drivers/renesas/rcar/emmc/emmc_write.c		\
